...
const jays = new Answer('Toronto Blue Jays', ['jays', 'blue jays']);
...
const philles = new Answer('Philadelphia Phillies', ['phillies']);
...
const cards = new Answer('St. Louis Cardinals', ['cards', 'red birds', 'cardinals']);
